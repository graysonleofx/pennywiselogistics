...
const testimonials = [
  {
    ...
    feedback: 'Pennywise Logistics has been a game changer for our business. Fast, reliable, and always professional!',
  ...
  },
  {
    ...
    feedback: 'We trust Pennywise for all our logistics needs. They always deliver on time and keep us updated.',
    ...
    <section id="testimonials" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <span className="text-orange-500 font-semibold text-lg mb-4 block">Testimonials</span>
